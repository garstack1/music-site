...
export default function ShareButtons({
  ...
  const url = typeof window !== "undefined" ? `${window.location.origin}/reviews/${slug}` : "";
  const text = `Check out this review of ${artist} at ${venue} on ${new Date(date).toLocaleDateString("en-IE", { day: "numeric", month: "long", year: "numeric" })}`;
